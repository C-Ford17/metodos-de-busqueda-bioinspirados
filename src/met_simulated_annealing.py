...
class SimAnneal(object):
    ...
    def anneal(self):
        ...
        return self.best_solution, self.best_fitness, sol_iter, self.fitness_list
    ...
    def visualize_routes(self, file):
        ...
        """
        plot_tsp([self.best_solution], self.coords, config=self.config(), file=file)


def plot_learning(fitness_list, title, file):
    """
    Plot the fitness through iterations.
    """
    xpoints = [i for i in range(len(fitness_list))]
    ypoints = fitness_list
    plt.clf()
    plt.title(title)
